...
class CreateForumCommentsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Forum_comments", 'forum_comments', 'body', 'fa-cube', [
            ["user_id", "User name", "Dropdown", false, "", 0, 0, true, "@users"],
            ["post_id", "Post", "Dropdown", false, "", 0, 0, true, "@forum_posts"],
            ["body", "Comment", "Textarea", false, "", 0, 0, true],
        ]);
