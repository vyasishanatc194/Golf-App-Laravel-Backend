...
if(!empty($videos)){
    foreach($videos as $key => $video){
        $htmlVideoOption .='<option value="'.$key.'">'.$video.'</option>';
    }
}

?>
<script>
    var htmlVideoOption = '<?php echo $htmlVideoOption; ?>';
    $(function () {
    ...
    $("#AddModuleBtn").on("click", function (e) {
        ...
        $strItems += '<select class="form-control" name="videos[]">'+htmlVideoOption+'</select>';
        $strItems += '</div>';
        $strItems += '</div>';
        $strItems += '</div>';
        $strItems += '</div>';
