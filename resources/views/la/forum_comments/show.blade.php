...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $forum_comment->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Forum_Comments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/forum_comments/'.$forum_comment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Forum_Comments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.forum_comments.destroy', $forum_comment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/forum_comments') }}" data-toggle="tooltip" data-placement="right" title="Back to Forum Comments"><i class="fa fa-chevron-left"></i></a></li>
