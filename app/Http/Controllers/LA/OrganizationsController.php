	...
	public function dtajax()
	{
		...
		for($i=0; $i < count($data->data); $i++) {
			...
			if($this->show_action) {
				$output = '';
				if(Module::hasAccess("Organizations", "edit")) {
					$output .= '<a href="'.url(config('laraadmin.adminRoute') . '/organizations/'.$data->data[$i][0].'/edit').'" class="btn btn-warning btn-lg" style="display:inline;padding:2px 5px 3px 5px;"><i class="fa fa-edit"></i></a>';
				}
				...
				if(Module::hasAccess("Organizations", "delete")) {
					...
					$output .= ' <button class="btn-danger" type="submit"><i class="fa fa-times"></i></button>';
					$output .= Form::close();
				}
