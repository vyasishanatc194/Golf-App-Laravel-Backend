...
@la_access("UniModules", "create")
	<div class="tab pull-left" style="margin-top:32px;">
			<button class="tablinks btn btn-primary btn-gradient waves-effect waves-light  " onclick="openLearning(event, 'Academy')">Academies</button>
			...
			<button class="tablinks btn btn-primary btn-gradient waves-effect waves-light active" onclick="openLearning(event, 'UniModule')">UniModules</button> 
	...
	<button style="margin-top:32px;" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add UniModule</button>
	@endla_access
@endsection
