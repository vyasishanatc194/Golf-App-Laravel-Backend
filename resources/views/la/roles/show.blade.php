			...
			<div class="card">
				<div class="card-header">	
					<ul data-toggle="ajax-tab" class="nav nav-pills card-header-pills" role="tablist">
						<li class="nav-item"><a class="nav-link" href="{{ url(config('laraadmin.adminRoute') . '/roles') }}" data-toggle="tooltip" data-placement="right" title="Back to Roles"><i class="fa fa-chevron-left"></i></a></li>
						<li class="nav-item"><a class="nav-link active show" role="tab" data-toggle="tab"  href="#tab-general-info" data-target="#tab-info"><i class="fa fa-bars"></i> General Info</a></li>
						@role("SUPER_ADMIN")
						<li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-access" data-target="#tab-access"><i class="fa fa-key"></i> Access</a></li>
						@endrole
					</ul>
				</div>
				<div class="card-body">
							...
							<div class="guide1">
								...
								<span class="pull-right">
									<i class="fa fa-circle"></i> Invisible
								 	<i class="fa fa-circle" style="color:#FF9800"></i> Read-Only 
													...
													<tr>
														@foreach ($fields as $field)
															<td>
																<div class="row">
																	<div class="col-sm-4">
																		<input type="text" name="{{ $field['colname'] }}_{{ $module->id }}_{{ $role->id }}" value="{{ $field['access'] }}" data-slider-value="{{ $field['access'] }}" class="slider form-control" data-slider-min="0" data-slider-max="2" data-slider-step="1" data-slider-orientation="horizontal"  data-slider-id="{{ $field['colname'] }}_{{ $module->id }}_{{ $role->id }}">
																	</div> 
																	<div class="col-sm-8">
																	{{ $field['label'] }} 
																	</div>
...
.hide{display:none;}
.guide1{text-align: right;margin: 0px 15px 15px 0px;font-size:15px;}
.guide1 .fa{font-size:22px;}
