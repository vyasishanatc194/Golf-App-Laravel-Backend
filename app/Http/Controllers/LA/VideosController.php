...
//                    $output .= '<a href="'.url(config('laraadmin.adminRoute') . '/videos/'.$data->data[$i][0].'/show_video').'" class="btn btn-primary btn-xs" style="display:inline;padding:2px 5px 3px 5px; margin-right: 3px;"><i class="fa fa-video-camera"></i></a>';
                    $output .= '<a href="' . url(config('laraadmin.adminRoute') . '/videos/' . $data->data[$i][0] . '/show_video') . '" class="btn btn-primary btn-sm" style="display:inline"><i class="fa fa-video-camera"></i></a>';
                }

                if (Module::hasAccess("Videos", "edit")) {
//                    $output .= '<a href="'.url(config('laraadmin.adminRoute') . '/videos/'.$data->data[$i][0].'/show_video').'" class="btn btn-primary btn-xs" style="display:inline;padding:2px 5px 3px 5px; margin-right: 3px;"><i class="fa fa-video-camera"></i></a>';
                    $output .= '<a href="' . url(config('laraadmin.adminRoute') . '/videos/' . $data->data[$i][0] . '/download') . '" class="btn btn-success btn-sm" style="display:inline" ><i class="fa fa-download"></i></a>';
                }

                if (Module::hasAccess("Videos", "edit")) {
                    $output .= '<a href="' . url(config('laraadmin.adminRoute') . '/videos/' . $data->data[$i][0] . '/edit') . '" class="btn btn-warning btn-sm" style="display:inline" ><i class="fa fa-edit"></i></a>';
                }
