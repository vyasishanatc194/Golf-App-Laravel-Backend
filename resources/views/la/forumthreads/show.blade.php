...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $forumthread->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Forumthreads", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/forumthreads/'.$forumthread->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Forumthreads", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.forumthreads.destroy', $forumthread->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/forumthreads') }}" data-toggle="tooltip" data-placement="right" title="Back to Forumthreads"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'enable_threads')
						@la_display($module, 'total_likes')
						@la_display($module, 'total_comments')
						@la_display($module, 'total_posts')
						@la_display($module, 'private')
						@la_display($module, 'image_path')
