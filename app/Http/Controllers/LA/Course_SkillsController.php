	...
	public function dtajax()
	{
		...
		for($i=0; $i < count($data->data); $i++) {
			...
			if($this->show_action) {
				$output = '';
				if(Module::hasAccess("Course_Skills", "edit")) {
					$output .= '<a href="'.url(config('laraadmin.adminRoute') . '/course_skills/'.$data->data[$i][0].'/edit').'" class="btn btn-warning btn-sm" style="display:inline;"><i class="fa fa-edit"></i></a>';
				}
