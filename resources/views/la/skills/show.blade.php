			...
			<div class="card">
				<div class="card-header">
					<ul data-toggle="ajax-tab" class="nav nav-pills card-header-pills" role="tablist">
						<li class="nav-item"><a class="nav-link" href="{{ url(config('laraadmin.adminRoute') . '/skills') }}" data-toggle="tooltip" data-placement="right" title="Back to Skills"><i class="fa fa-chevron-left"></i></a></li>
