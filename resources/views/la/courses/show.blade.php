		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<ul class="nav nav-pills card-header-pills" id="myTab-7" role="tablist">
						<li class="nav-item">
							<a   class="nav-link" href="{{ url(config('laraadmin.adminRoute') . '/courses') }}" data-toggle="tooltip" data-placement="right" title="Back to Courses">
								<i class="fa fa-chevron-left"></i>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link active show" role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info">
								<i class="fa fa-bars"></i> General Info
							</a>
						</li>
						<li class="nav-item">
							<a  class="nav-link" role="tab" data-toggle="tab" href="#tab-timeline" data-target="#tab-timeline">
