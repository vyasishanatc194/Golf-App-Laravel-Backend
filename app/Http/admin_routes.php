...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
    ...
    Route::get(config('laraadmin.adminRoute') . '/reviews_dt_ajax', 'LA\ReviewsController@dtajax');

    /* ================== ForumCategories ================== */
    Route::resource(config('laraadmin.adminRoute') . '/forumcategories', 'LA\ForumCategoriesController');
    Route::get(config('laraadmin.adminRoute') . '/forumcategory_dt_ajax', 'LA\ForumCategoriesController@dtajax');

	/* ================== Forumthreads ================== */
	Route::resource(config('laraadmin.adminRoute') . '/forumthreads', 'LA\ForumthreadsController');
	Route::get(config('laraadmin.adminRoute') . '/forumthread_dt_ajax', 'LA\ForumthreadsController@dtajax');




    /* ================== Forum_Posts ================== */
    Route::get(config('laraadmin.adminRoute') . '/forum_posts/{thread_id?}', 'LA\Forum_PostsController@index');
	Route::resource(config('laraadmin.adminRoute') . '/forum_posts', 'LA\Forum_PostsController');
	Route::get(config('laraadmin.adminRoute') . '/forum_post_dt_ajax', 'LA\Forum_PostsController@dtajax');

    /* ================== Forum_Comments ================== */
    Route::get(config('laraadmin.adminRoute') . '/forum_comments/{post_id?}', 'LA\Forum_CommentsController@index');
	Route::resource(config('laraadmin.adminRoute') . '/forum_comments', 'LA\Forum_CommentsController');
	Route::get(config('laraadmin.adminRoute') . '/forum_comment_dt_ajax', 'LA\Forum_CommentsController@dtajax');
});
